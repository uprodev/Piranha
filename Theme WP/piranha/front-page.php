...
?>
    ...
    <section class="home-section-1">
        <div class="container-fluid">
            <div class="text animated-color">Piranha Technologies remains one of the leaders in electronic warfare, constantly innovating and improving its products to ensure the safety and effectiveness of military operations</div>
            <div class="video">
